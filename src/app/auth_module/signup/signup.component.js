System.register(['angular2/core', 'angular2/router', 'angular2/common', '../../shared/validators/common', '../../shared/services/data.service', '../auth/auth', '../auth/check_auth'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, common_1, common_2, data_service_1, auth_1, check_auth_1;
    var SignupComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            SignupComponent = (function () {
                function SignupComponent(_router, _dataService, _auth, _formBuilder) {
                    ...
                    this.appName = new common_1.Control("", common_1.Validators.compose([common_1.Validators.required]));
                    this.username = new common_1.Control("", common_1.Validators.compose([common_1.Validators.required]));
                    this.email = new common_1.Control("", common_1.Validators.compose([common_1.Validators.required, common_2.CommonValidators.email]));
                    this.password = new common_1.Control("", common_1.Validators.compose([common_1.Validators.required]));
                    this.passwordConfirm = new common_1.Control("", common_1.Validators.compose([common_1.Validators.required]));
                    ...
                    }, { validator: common_2.CommonValidators.matchingPasswords('password', 'passwordConfirm') });
                }
